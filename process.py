...
class DragonLongformerLargeDomainSpecific(DragonBaseline):
    def __init__(self, **kwargs):
        """
        Adapt the DRAGON baseline to use the joeranbosma/dragon-longformer-large-domain-specific model.
...
if __name__ == "__main__":
    DragonLongformerLargeDomainSpecific().process()
